...
def test_duplicate_sample():
    s = SampleReference(host=TESTING_CONFIG["host"], port=TESTING_CONFIG["port"])
...
def test_find_sample():
    ...
    s1 = SampleReference(host=TESTING_CONFIG["host"], port=TESTING_CONFIG["port"])
    s1.create(**m_sample)
...
def test_update_sample():
    ...
    samp = SampleReference(host=TESTING_CONFIG["host"], port=TESTING_CONFIG["port"])
